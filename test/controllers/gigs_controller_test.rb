...
class GigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post gigs_url, params: { gig: { date: @gig.date, description: @gig.description, name: @gig.name } }
    end
  ...
  test "should update gig" do
    patch gig_url(@gig), params: { gig: { date: @gig.date, description: @gig.description, name: @gig.name } }
